<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	import="model.Compra" import="dao.CompraDAO" import="model.PacotesViagem"%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%
List<Compra> listaCompras = (List<Compra>) request.getAttribute("compra");
%>
		...
		<section class="container">
			<div class="p-4">
				<div class="row justify-content-center">
					<a href="./views/Compras/create.jsp" class="btn mb-2 botao1" style="background-color: #FFA500"> Nova
						Compra </a>
				</div>
				...
				<table class="table table-responsive table-hover">
					...
					<tbody>
						...
						<tr>
							<td><%=c.getId_compra()%></td>
							<td><%=c.id_pacote()%></td>
							<td><%=c.id_cliente()%></td>
							<td><%=c.getQtd_itens()%></td>
							<td><%=c.getDataCompra()%></td>
							<td><%=c.valorCompra()%></td>
							<td>
							
								<div class="d-flex">
									<a href="./update-compra?id_compra=<%=c.getId_compra()%>" class="mx-1"
										title="Editar"> <i class="ri-file-edit-line"></i>
									</a> <a href="delete-compra?id_compra=<%=c.getId_compra()%>" class="mx-1"
										title="Cancelar"
