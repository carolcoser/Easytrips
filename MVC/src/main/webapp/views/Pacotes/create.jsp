...
<link
	...
	rel="stylesheet">
<title>Easytrips | Cadastrar Pacote</title>
</head>
<body>
	...
	<main>
		...
		<div class="container py-3">
			<form action="../../create-pacote">
				<h2 class="text-center">Novo Pacote</h2>


				<div class="form-group mb-3">
					<label for="id_pacote" class="form-label"> ID Pacote </label> <input
						type="number" id="id_pacote" name="id_pacote"
						class="form-control" />
				</div>

				<div class="form-group mb-3">
					<label for="id_destino" class="form-label"> ID Destino </label> <input
						type="number" id="id_destino" name="id_destino"
						class="form-control"/>
				</div>
				...
				<div class="form-group mb-3">
					<label for="valor_pacote" class="form-label"> Valor: R$ </label> <input
						type="number" id="valor_pacote" name="valor_pacote"
						class="form-control"/>
				</div>
